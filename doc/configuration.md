...
|---|---|---|---|
| `openai` | `gpt-4o-mini` | OpenAI 既定 | `OPENAI_API_KEY`（または `LLM_API_KEY`） |
...
`gpt-3.5-turbo` / `gpt-3.5-turbo-0301` / `gpt-4o-mini` / `qwen2.5-72b-instruct` /
`Llama-3.1-70B-Instruct` / `gemini-3.5-flash` / `google/gemini-3.5-flash`
